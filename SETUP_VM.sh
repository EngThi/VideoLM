...
echo "2. Run 'uv tool install notebooklm-mcp-cli' if nlm is not installed."
echo "3. Run 'nlm login && nlm login --check && nlm doctor' to set up NotebookLM."
echo "4. Run 'docker compose up -d --build' to start the factory."
echo "------------------------------------------------"
